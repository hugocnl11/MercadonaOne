...
class MercadonaShopOneTest {
    ...
    void item_yogurt_no_caducado() {
        Item[] items = new Item[] { new Item("Yogurt", 1, 2) };
        MercadonaShopOne app = new MercadonaShopOne(items);
        app.updateQuality();
    ...
    void item_yogurt_caducado() {
        Item[] items = new Item[] { new Item("Ham", -2, -4) };
        MercadonaShopOne app = new MercadonaShopOne(items);
        app.updateQuality();
    ...
    void item_frozen_cake_no_caducado() {
        Item[] items = new Item[] { new Item("Frozen fish", 0, 0) };
        MercadonaShopOne app = new MercadonaShopOne(items);
        app.updateQuality();
        assertEquals("Frozen fish", app.items[0].name);
        assertEquals(-1, app.items[0].sellIn);
        assertEquals(-4, app.items[0].quality);
